    ...
    public static void init() {
        try {
            ...
            if (biomeF.get((Object)null) instanceof BiomeBase[]) {
                ...
                swap(biomes, BiomeBase.EXTREME_HILLS_PLUS, BiomeBase.FOREST);
                swap(biomes, BiomeBase.BIRCH_FOREST, BiomeBase.FOREST);
                swap(biomes, BiomeBase.BIRCH_FOREST_HILLS, BiomeBase.ROOFED_FOREST);
                swap(biomes, BiomeBase.SAVANNA_PLATEAU, BiomeBase.ROOFED_FOREST);
                swap(biomes, BiomeBase.PLAINS, BiomeBase.ROOFED_FOREST);
                swap(biomes, BiomeBase.FOREST, BiomeBase.ROOFED_FOREST);
                swap(biomes, BiomeBase.SAVANNA, BiomeBase.ROOFED_FOREST);
            }
